 ...
 const navigate = useNavigate();
  ...
  return (
    <div class="w-full max-w-xs container mx-auto">
      <div style = {styles} class=" p-6 text-xl text-white rounded-br-3xl justify-center">
      ...
      <div class="text-center mt-6 ">
        ...
        <h1 class="border-b-2 border-b-black pb-3 pt-16">
          <div class="row">
      ...
      <div class="relative">
        <div class="absolute bottom-0 right-2 top-12">
          <button class="bg-blue-500 text-white py-1 px-8 rounded-md inline-flex justify-between content-center" onClick={() => navigate("/confirm")}>
            Next{" "}
            <span>
              <svg
