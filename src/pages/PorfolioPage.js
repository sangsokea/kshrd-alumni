          ...
          <div className="md:w-1341 min-h-1079  rounded shadow-2xl">
            <div className="md:grid md:grid-cols-3  flex flex-wrap-reverse">
              <div className=" col-span-2 text-left md:ml-14 ml-2  font-maven md:mr-56">
                <p className="md:mt-24 md:text-4xl mt-10 text-1xl font-extrabold ">
                ...
                <div className="text-left ">
                  <div className="bg-black_c mt-2 md:text-xl  text-sm rounded md:w-404 md:h-8 w-56 h-5">
                    <div className="md:grid grid-cols-3">
                      <div>
                        <img className="mt-2 ml-3" src={ellipes} alt="" />
                      </div>
                      <div className="col-span-2 -ml-24">
                        <p className="font-bold font-maven text-white">
                          {" "}
            ...
            <div className="md:grid md:grid-cols-8  md:mt-11">
              <div className="">
                <div className="bg-black_c md:ml-0 -ml-80 h-6 w-6 mt-24 rounded-full "></div>
                <div className="md:ml-16 md:min-h-1/24 md:mt-5 -mt-6 ">
                  <p className="md:ml-2 -ml-28 font-maven font-bold  w-24">
                    2016 - 2020{" "}
                  </p>
                  <p className="font-maven md:text-md text-sm ml-3  text-left font-bold w-56">
                    Bachelor Degree,Computer Science and Engineering
                  </p>
                  <p className="font-maven md:text-sm text-tinys ml-3 text-left  w-56">
              ...
              <div className="">
                <div className="md:ml-16  md:min-h-1/24">
                  <p className="font-maven  text-sm ml-10 md:ml-3 md:mt-0 mt-20 text-left  w-64">
                    Paññāsāstra University of Cambodia
                  </p>
                  <p className="font-maven text-md ml-3 text-left font-bold  w-56">
                    Graduated Diploma in English
                  </p>
                  <p className="font-maven font-bold md:ml-1 -ml-28 ">
                    2017 - 2018
                  </p>
                </div>
                <div className="bg-black_c h-6 w-6 md:mt-1 -mt-5 md:ml-0 -ml-80  rounded-full"></div>
              </div>
              <div className="">
                <div className="bg-black_c md:ml-0 -ml-80 h-6 w-6 mt-24 rounded-full "></div>
                <div className="md:ml-16 md:min-h-1/24 md:mt-5 -mt-6">
                  <p className="-ml-7 font-maven font-bold w-56">
                    2018 Oct - 2019 Jan
                  </p>
                  <p className="font-maven text-md ml-3  font-bold text-left  w-56">
                    Certificate if Java Course
                  </p>
                  <p className="font-maven text-sm md:ml-3 ml-10 text-left  w-64">
              ...
              <div className="">
                <div className="md:ml-16 md:min-h-1/24">
                  <p className="font-maven text-sm ml-3 md:mt-0 mt-20 text-left w-56">
                    Korea Software HRD Center
                  </p>
                  <p className="font-maven text-md ml-3 text-left font-bold w-56">
                    Software Expert Training
                  </p>
              ...
              <div className="">
                <div className="bg-black_c md:ml-0 -ml-80 h-6 w-6 mt-24 rounded-full "></div>
                <div className="md:ml-16 md:min-h-1/24 md:mt-5 -mt-6">
                  <p className="-ml-10 font-maven font-bold w-56">
                    2020 - PRESENT
                  </p>
                  <p className="font-maven text-md md:ml-3 ml-10 font-bold  text-left  md:w-80">
                    IT Instructor at Korea Software HRD Center
                  </p>
                  <p className="font-maven text-sm md:ml-3 ml-10 text-left  w-64">
                    Korea Software HRD Center
                  </p>
              ...
              <div className="">
                <div></div>
                <div className="bg-black_c relative z-50 h-6 w-6 mt-24 rounded-full md:inline-block hidden"></div>
              </div>
              <div className="">
                <div></div>
              ...
              <div className="">
                <div>
                  <p className="text-left md:mt-25 mt-2 md:text-2xl text-xl md:-ml-11 ml-2 font-bold font-maven">
                    TIMELINE
                  </p>
                </div>
              </div>
            ...
            <div className="md:grid md:grid-cols-3 md:mt-24 mt-10">
              <div className="text-left ml-14 mt-4 col-span-2">
                <div className="gap-2 flex font-maven">
                  <ui>
                    <li class="fff md:text-xl ">
                      Web Application Development: Spring Framework, NodeJS,
                      ReactJS
                    </li>
                    <li class="fff md:text-xl mt-2">
              ...
              <div className="">
                <img className="md:-ml-56 mt-3 md:mt-0" src={img3}></img>
              </div>
            </div>
          </div>
        </center>
