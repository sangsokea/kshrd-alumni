...
const [title, setTitleValues] = useState("Full Stack + UI designer from KSHRD . ")
const [desc, setDescValues] = useState("I have a deep interest in Science with the intention to bring the world to a new evolution of technology. ")
const [status, setStatusValues] = useState("Looking for a Summer 2022 Internship")
...
const handleStudyChange = (e) => {
  setStudyValues(e.target.value);
   ...
   const handleSubmit = (e) => {
    ...
    alert(JSON.stringify({ title, desc,status, school, study, technology, file }));
                  ...
                  <div className="relative  gap-8 bg-white p-7 ">
                   ...
                   >
                    ...
                    <div>
                            ...
                            <button 
                                  class=" mt-10 bg-blue-500 hover:bg-blue-700 text-white font-maven mr-3 py-2 px-4 w-36 h-12 rounded mb-6" onClick={handleSubmit}>
                                    Update</button>
                            <button 
          ...
          {/* {TitleValues.map((element, index) => ( */}
            <div>
                <button
                                ...
                                >
                                    {vall?<Add className='mr-2 mt-1 w-6'></Add>:<Removed className='mr-2 mt-1 w-6'></Removed>}
                         ...
                         <button
                                ...
                                >
                                    {Desc?<Add className='mr-2 mt-1 w-6'></Add>:<Removed className='mr-2 mt-1 w-6'></Removed>}
                            ...
                            <button
                                ...
                                >
                                    {Status?<Add className='mr-2 mt-1 w-6'></Add>:<Removed className='mr-2 mt-1 w-6'></Removed>}
                    ...
                    <div className={file ?'upload-btn-wrapper mr-24 md:mt-14  bg-cover bg-center rounded-tl-tl-lgs ':'upload-btn-wrapper bg-white shadow-lg left-2 ml-2  md:mt-12 h-40 w-80  rounded-tl-lg' }>
                       {file?<button class="btn   inline-flex justify-center mb-20  content-center "></button>:<button class="  mt-12 inline-flex justify-between content-center font-maven text-xl "><Img className='w-6 mr-2 -mt-1 rounded-md'></Img>+ Click to add image</button>} 
                        <input type="file" name="myfile" onChange={handleChange}/>
                        <img src={file} className='shadow-lg left-2   object-contain -mt-24 rounded-tl-lg'/>
                    </div>
                ...
                <div className='md:grid md:grid-cols-3 mt-2 relative flex flex-wrap-reverse'>
                    <div className='col-span-2  mt-14 text-left md:ml-20 ml-2  font-maven md:mr-'>
                            <button
                                ...
                                >
                                    {Education?<Add className='mr-2 mt-1 w-6'></Add>:<Removed className='mr-2 mt-1 w-6'></Removed>}
                                            ...
                                            <div className='grid grid-cols-2 '>
                                                <div className='mb-5'>   
                                                   ...
                                                   <div className="">
                                                      ...
                                                      <select id="countries" class="ml-10 w-32 mt-5  outline outline-offset-2 outline-1 py-2 px-3 rounded text-gray-700 leading-tight focus:outline-blue-700 focus:shadow-outline bg-slate-50 text-left inline-flex justify-between content-center">
                                                      ...
                                                      <select id="countries" class="ml-2 w-32 mt-5 outline outline-offset-2 outline-1 py-2 px-3 rounded text-gray-700 leading-tight focus:outline-blue-700 focus:shadow-outline bg-slate-50 text-left dark:text-placeholder-blue-500 inline-flex justify-between content-center">
                            ...
                            <button
                                ...
                                >
                                    {Technology?<Add className='mr-2 mt-1 w-6'></Add>:<Removed className='mr-2 mt-1 w-6'></Removed>}
                    ...
                    <div className=''>
                                <img 
                                 className='md:-ml-56 mt-3 md:mt-14'
                                 src={img3}>
                                </img>
                                <div classname="">
                                <button class="-ml-20 mt-24 bg-blue-500 hover:bg-blue-700 text-white font-maven mr-3 py-2 px-4 w-36 h-12 rounded mb-6" onClick={handleSubmit}>Save</button>
