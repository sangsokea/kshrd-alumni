        ...
        <div className="body-font font-maven tablet:p-10 rounded-tr-lg rounded-br-lg h-full grid-cols-2">
          <div className="flex flex-row portolio-header">
            {/* <div>
              ...
              <p className="text-2xl font-bold mb-5" style={textStyle}>
                Vong Yuoyi
              </p>
            </div> */}
          ...
          {/* Table */}
          <div className="relative overflow-x-auto overflow-scroll shadow-md sm:rounded-lg list-resume">
            <table
            ...
            >
              ...
              <thead
                className="text-m text-white uppercase sticky top-0	background-color: rgb(2 132 199);"
                style={styles}
              >
                <tr>
              ...
              <tbody>
                {resumes?.length !== 0 ? (
                  ...
                  <div class="absolute w-full flex justify-center ">
                    <img src={NodataImg} class="object-cover h-48 w-96 " />
                  </div>
                )}
              </tbody>
            </table>
