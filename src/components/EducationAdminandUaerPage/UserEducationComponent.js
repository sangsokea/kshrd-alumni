                    ...
                    <div className="">
                      <div className="mb-5">
                        ...
                        <div className="">
                          ...
                          <select
                            id="countries"
                            class="laptop:ml-3  laptop:w-1/4 w-full  mt-5 border border-[#255FAB] laptop:py-1 desktop:py-2 px-3  py-1 rounded-md text-gray-700 leading-tight focus:outline-blue-700 focus:shadow-outline bg-slate-50 text-left  inline-flex justify-between content-center"
                          >
